...
// //   // profileData me backend se fetch kiya hua asali data hoga
// //   const [profileData, setProfileData] = useState<any>(null); 
  
// //   // editData me hum wo data rakhenge jo user edit kar raha hai
...
// //       // Fiza ka rule yaad rakhna: teacherID use karna hai ya teacherId
// //       const tId = profileData.teacherID || profileData.teacherId;

// //       await axios.put(`http://localhost:8080/api/teachers/${tId}`, payload);
      
// //       // Update successful hone par UI update karo aur edit mode band karo
...
// //       <span className="text-red-500">👤</span> Personal Information
// //     </CardTitle>
...
//         const data = await getTeacherByEmail(user.emailId);
//         setTeacherData(data);
//         setProfileData(data); // 🚨 FIX: Ye line miss thi, iske bina UI khali dikhta!
//       } catch (error) {
//         console.error("Fetch error:", error);
//         toast({
//           title: "Error",
...
//       // Update successful hone par dono states update karo
//       setProfileData(payload);
//       setTeacherData(payload); // 🚨 FIX: Isse upar wala Avatar aur Naam bhi instantly update hoga
//       setIsEditing(false);
//       toast({ title: 'Success', description: 'Profile updated successfully!' });
//     } catch (error) {
//       toast({ title: 'Error', description: 'Failed to update profile.', variant: 'destructive' });
