...
const Dashboard = () => {
  ...
  // 🔥 State to store real-time stats from MySQL
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      ...
      // 🔥 Fetching data from your QuizBattleController API
      // studentId agar user object mein nahi hai toh default 101 use hoga testing ke liye
      ...
      fetch(`http://localhost:8080/api/quiz-battles/student/${studentId}`)
        ...
        .then((data) => {
          if (Array.isArray(data)) {
            // Logic: Count as 'Won' if score is above a certain threshold (e.g., 50)
