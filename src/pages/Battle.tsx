...
const Battle = () => {
  ...
  try {
    ...
    const pNumber = players.indexOf(playerId) + 1 || 1;
    console.log(playerId, roomCode, numericQuizId,pNumber, players);
    const battleData = {
      quizNumber: numericQuizId,   // Real numeric part of room code
      playerNumber: pNumber,       // Sequence of player in lobby
      studentId: playerId,         // Real student ID from Auth/State
  ...
  try {
    ...
    setTimeout(() => createBattleEntry(studentId, "LIVE"), 500);
